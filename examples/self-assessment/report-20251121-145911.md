...
|------------|--------|--------|-------|-------|------|
| **git@github.com:ambient-code/agentready.git** | 002-fix-critical-security-bugs | `d7550655` | **80.0/100** | **Gold** | 2025-11-21 14:59 |
...
- **Repository Snapshot**: d755065592256da1a12a72524431440f7d297bf9
- **Assessment Duration**: 2.1s
